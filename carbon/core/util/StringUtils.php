...
class StringUtils {
    ...
    /**
     * Check whether two strings equal to each other. Arrays may be supplied. If any string in one of the arrays equals,
     * true will be returned.
     *
     * @param string|Array $strs1 First string or an array of strings
     * @param string|Array $strs2 Second string or an array of strings
     * @param bool $matchCase True to ensure the case matches, false otherwise
     * @param bool $trim True to trim whitespaces first from the two strings
     *
     * @return bool True if the two strings match, false otherwise
     */
    public static function equals($strs1, $strs2, $matchCase = true, $trim = false) {
        // Convert both $strs1 and $strs2 into an array
        if(!is_array($strs1))
            $strs1 = Array($strs1);
        if(!is_array($strs2))
            $strs2 = Array($strs2);
