...
namespace carbon\core\filesystem\directory;
...
class DirectoryUtils extends FilesystemObjectUtils {
     ...
     *
     * @param \carbon\core\filesystem\FilesystemObject|string $dir Filesystem object instance or the path of a directory as a string.
     *
    ...
    public static function isValid($dir) {
        ...
        if(!FilesystemObjectUtils::isValid($dir))
            return false;

        // Make sure the directory isn't a file or symbolic link, return the result
        return !(FilesystemObjectUtils::isFile($dir) || FilesystemObjectUtils::isSymbolicLink($dir));
    }
}