...
class SymbolicLinkUtils extends FilesystemObjectUtils {
     ...
     *
     * @param \carbon\core\filesystem\FilesystemObject|string $target Target of the link.
     * @param \carbon\core\filesystem\FilesystemObject|string $link The link name.
     *
     ...
     *
     * @return Directory|\carbon\core\filesystem\file\File|SymbolicLink|FilesystemObject|null
     ...
     *
     * @param FilesystemObject|string $link Filesystem object instance or the path as a string.
     *
    ...
    public static function isValid($link) {
        ...
        if(!FilesystemObjectUtils::isValid($link))
            return false;

        // TODO: Use better validation!

        // Make sure the symbolic link isn't a an existing file or directory, return the result.
        return !(FilesystemObjectUtils::isFile($link) || FilesystemObjectUtils::isDirectory($link));
    }
}
