...
class FileUtils extends FilesystemObjectUtils {
    ...
    /**
     * Validate a file or the path of a file. The file doesn't need to exist.
    ...
    public static function isValid($file) {
        ...
        if(!FilesystemObjectUtils::isValid($file))
            return false;

        // Make sure the file isn't a directory or symbolic link, return the result
        return !(FilesystemObjectUtils::isDirectory($file) || FilesystemObjectUtils::isSymbolicLink($file));
    }
}
