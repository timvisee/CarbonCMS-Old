...
use core\Core;
use core\Database;
use core\exception\registry\CarbonRegistryException;
...
class RegistryHandler {
    ...
    private $cache = null;
    /** @var string $cache_file_name File name of the registry cache file */
    private $cache_file_name = 'registry';
    /** @var int $cache_max_age Maximum age of the cache in seconds before it's being ignored */
     ...
     * @throws CarbonRegistryException Throws exception if a proper Database instance couldn't be found
     */
    public function __construct($db = null) {
        // Check whether the $db param was set
        if($db == null) {
    ...
    public function get($key, $def = null) {
        ...
        if($this->isCachingEnabled()) {
            ...
            if($this->cache->isCached($this->cache_file_name)) {
                // Make sure the registry cache data isn't out of date
    ...
    public function delete($key) {
        // TODO: Param: if exceptions should be thrown if registry keys doesn't exist, or not
    ...
    public function setDatabase($db) {
        // TODO: Rename to setDatabaseInstance($db);?
