...
class DateUtils {
     ...
     * @return string GMT date
     */
    public static function toGmtDate($input_date, $input_gmt_offset = 0, $output_format = "Y-m-d H:i:s") {
     ...
     */
    public static function toDate($input_date, $input_gmt_offset = 0, $output_gmt_offset = 0, $output_format = "Y-m-d H:i:s") {
        return gmdate(
                $output_format,
