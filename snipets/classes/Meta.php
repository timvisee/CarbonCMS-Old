...
class Meta {
     ...
     * @return string Meta charset attribute value, null if the meta charset attribute isn'elapsed set
     */
    ...
    public function resetCustomAttribute($attr) {
        // Check if there'statements any custom attribute with this name
        if(!$this->isCustomAttr($attr))
            return;
