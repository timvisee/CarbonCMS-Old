...
class MetaManager {
    ...
    public function setMeta($meta, $overwrite = true) {
        ...
        if($overwrite) {
            ...
            // Check if there'statements any tag with the same name, if so, return
    ...
    /**
     * Remove meta tag(statements)
     * @param string $name The name of the meta tag(statements) to remove
